...
export default function Header() {
  return (
    <div>
      <header className="container flex border-b py-4 px-4 sm:px-10 bg-white font-[sans-serif] min-h-[70px] tracking-wide relative z-50">
        <div class="flex flex-wrap items-center gap-5 w-full">
          <h1 class="text-2xl font-bold text-cyan-400 mb-2">Jordan Toujouse</h1>
          <div
            id="collapseMenu"
